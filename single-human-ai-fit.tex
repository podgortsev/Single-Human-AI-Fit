...
\title{\textbf{Single Human-AI Fit:\\ Measuring the Cost of Departing from the
Average User in Language Models}}
...
We report two negative results in full. Signals do not appear to compound in
the way expected, and response stability does not degrade for people who
disclose: of 33 cells, 7 are less stable and 10 are more stable. One method,
...
public. Every reported figure regenerates without a GPU.
\end{abstract}
...
offline validators that regenerate every number without a GPU.
\end{enumerate}
...
changes \cite{names2026}, and documented position bias in paired-CV comparison
\cite{peerj2026}. That last result is the failure mode our method 6a
encountered directly, and we confirm it independently.
...
selfpref2025}. Method 7 asks whether a model can report on its own behaviour,
...
points. Any single-wrapper study inherits that as unreported uncertainty, and
...
\textbf{zero of nine cells} after correction. The model identifies that the
...
All datasets, raw model outputs, analysis scripts and offline validators are
available at \url{https://github.com/podgortsev/Single-Human-AI-Fit}. Every
figure and table in this paper regenerates from the committed CSV files without
a GPU.

\begin{thebibliography}{99}

\bibitem{daniels1952} Daniels, G.\ S. (1952). \emph{The ``Average Man''?}
Technical Note WCRD 53-7, Wright Air Development Center.
...
\bibitem{kusner2017} Kusner, M.\ J., Loftus, J.\ R., Russell, C., Silva, R.
(2017). Counterfactual Fairness. \emph{Advances in Neural Information
Processing Systems 30}.

\bibitem{gallegos2024} Gallegos, I.\ O., et al.\ (2024). Bias and Fairness in
Large Language Models: A Survey. \emph{Computational Linguistics}.
\url{https://doi.org/10.1162/coli_a_00524}

\bibitem{redirected2026} \emph{Redirected, Not Removed: Task-Dependent
Stereotyping Reveals the Limits of LLM Alignments} (2026).
arXiv:2604.02669.
...
Persons with Disabilities. \emph{Proceedings of ACL 2020}.

\bibitem{faccT2023} ``I wouldn't say offensive but\ldots'': Disability-Centered
Perspectives on Large Language Models. \emph{FAccT 2023}.

\bibitem{accesseval2025} \emph{AccessEval: Benchmarking Disability Bias in
Large Language Models} (2025). arXiv:2509.22703.

\bibitem{ableist2025} \emph{ABLEIST: Intersectional Disability Bias in
LLM-Generated Hiring Scenarios} (2025). arXiv:2510.10998.

\bibitem{whosasking2025} \emph{Who's Asking? Investigating Bias Through
Disability-Framed Queries in LLMs} (2025). arXiv:2508.15831.

\bibitem{hiring2024} \emph{Do Large Language Models Discriminate in Hiring
Decisions on the Basis of Race, Ethnicity, and Gender?} (2024).
arXiv:2406.10486.

\bibitem{names2026} \emph{When Names Change Verdicts: Intervention Consistency
Reveals Systematic Bias in LLM Decision-Making} (2026). arXiv:2603.18530.

\bibitem{peerj2026} Gender and positional biases in LLM-based hiring:
comparative CV/r\'esum\'e evaluations. \emph{PeerJ Computer Science} (2026).
...
\bibitem{dialect2024} \emph{Linguistic Bias in ChatGPT: Language Models
Reinforce Dialect Discrimination} (2024). arXiv:2406.08818.

\bibitem{zheng2023} Zheng, L., et al.\ (2023). Judging LLM-as-a-Judge with
MT-Bench and Chatbot Arena. \emph{Advances in Neural Information Processing
Systems 36}.

\bibitem{selfpref2025} \emph{Measuring Self-Preference in LLM Judgments}
(2025). \emph{Proceedings of EMNLP 2025}.

\bibitem{tellme2025} \emph{Tell Me About Yourself: LLMs Are Aware of Their
Learned Behaviors} (2025). arXiv:2501.11120.

\bibitem{alignedblind2025} \emph{Aligned but Blind: Alignment Increases
Implicit Bias by Reducing Awareness of Race} (2025). arXiv:2506.00253.
